...
declare function getGPUInfo(): Promise<GPUInfo[]>;
...
declare namespace computer {
	export { getArch, getCPUInfo, getDisks, getDisplays, getGPUInfo, getHostname, getKernelInfo, getMachineId, getMemoryInfo, getMousePosition, getNetworkInterfaces, getOSInfo, sendKey, setMouseGrabbing, setMousePosition };
}
